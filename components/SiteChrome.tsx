...
const nav = [["Music","/music"],["Worlds","/worlds"],["Cinema","/cinema"],["About","/about"],["Industry","/industry"],["EPK","/epk"],["Request","/request"]];
...
export function SiteFooter(){
  return <footer className="site-footer"><div><strong>BOSSIE</strong><span>ON THE BEAT</span></div><div className="footer-copy">EVERY TRACK IS A NEW WORLD.<br/><small>© 2026 BOSSIE ON THE BEAT · <Link href="/privacy">PRIVACY</Link></small></div><a className="vdb-credit" href="https://vdbdigital.nl" target="_blank" rel="noreferrer"><small>BUILT BY</small><strong>VDB DIGITAL ↗</strong></a></footer>
}
